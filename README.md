# Awesome React Framer X with stars
...
* [React Rapid Course](https://www.youtube.com/watch?v=MhkGQAoc7bc\&list=PLoYCgNOIyGABj2GQSlDRjgvXtqfDxKm5b) - This React Course will help you get quickly up to pace with React.js development - [Source Code](https://github.com/learncodeacademy/react-js-tutorials) ⭐ 1,662 | 🐛 26 | 🌐 JavaScript | 📅 2018-12-11.
* [ReactJS Crash Course](https://youtu.be/A71aqufiNtQ) - Learn the fundamentals of React.js, by [@traversymedia](https://twitter.com/traversymedia) - [Source Code](https://github.com/bradtraversy/projectmanager) ⭐ 142 | 🐛 1 | 🌐 JavaScript | 📅 2022-08-27.
...
* [React For Beginners](https://reactforbeginners.com/) - [Source Code](https://github.com/wesbos/React-For-Beginners-Starter-Files) ⭐ 2,904 | 🐛 32 | 🌐 JavaScript | 📅 2023-05-16 - Learn React.js in just a couple of afternoons, by [@wesbos](https://twitter.com/wesbos).
...
* [TypeScript Cheatsheet](https://github.com/sw-yx/react-typescript-cheatsheet) ⭐ 47,099 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-29 - A TypeScript cheatsheet by \[@swyx] and \[@islamAttrash]
...
* [How to create a styled-component in Framer X](https://www.zauberware.com/en/articles/2018/how-to-create-a-styled-component-in-framerx/) - [Simon Franzen](https://twitter.com/franzen_simon), software developer at [zauberware](https://twitter.com/zauberware), shows how to install [styled-components](https://github.com/styled-components/styled-components) ⭐ 41,128 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-11 for a Framer X project and how to create a basic button component., Oct 20, 2018.
...
* [Transform](https://transform.now.sh/) - Tool to transform JS objects to get something useful \[CSS-to-JS, CSS-to-Emotion, HTML-to-JSX and many more]. [Source](https://github.com/transform-it/transform-www) ⭐ 9,196 | 🐛 82 | 🌐 TypeScript | 📅 2026-01-28.
...
* [Visual Studio Code](https://code.visualstudio.com/download) - VS Code is a fast, lightweight, code editor developed by Microsoft. Is open source, comes with built-in support for `JavaScript`, `TypeScript` and `Node`.
  * [Awesome VS Code List](https://github.com/viatsko/awesome-vscode) ⭐ 28,953 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-21.
...
* [Framer X Build System](https://github.com/shiftsave/framerx-build-system) ⭐ 159 | 🐛 8 | 🌐 CSS | 📅 2018-10-26 - A build system to transpile React components for use in Framer X - Check out the ([intro blog post](https://blog.prototypr.io/bringing-design-system-components-from-production-into-framer-x-786e89be2250)).
* [Framer Tools](https://github.com/steveruizok/framer-tools) ⚠️ Archived - Create code components for your Framer X file right from the command line, created by [Steve Ruiz](https://twitter.com/steveruizok/).
...
* [Awesome React](https://github.com/enaqx/awesome-react) ⭐ 74,266 | 🐛 70 | 📅 2026-07-20 - A collection of awesome things regarding React ecosystem.
