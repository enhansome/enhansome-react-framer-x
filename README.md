...
* [Visual Studio Code](https://code.visualstudio.com/download) - VS Code is a fast, lightweight, code editor developed by Microsoft. Is open source, comes with built-in support for `JavaScript`, `TypeScript` and `Node`.
  * [Awesome VS Code List](https://github.com/viatsko/awesome-vscode) ⭐ 29,044 | 🐛 62 | 🌐 JavaScript | 📅 2026-06-21.
...
* [Awesome React](https://github.com/enaqx/awesome-react) ⭐ 74,629 | 🐛 12 | 📅 2026-09-04 - A collection of awesome things regarding React ecosystem.
